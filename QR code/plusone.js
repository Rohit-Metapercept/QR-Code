...
(function() {
    ...
    var Qa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Xa = function(a, b, c, d) {
            ...
            b = k;
            c = b.match(Ua);
            (d = b.match(Va)) && 1 === d.length && Wa.test(b) && c && 1 === c.length || N("failed sanity: " + a);
            return k
        },
        $a = function(a, b, c, d) {
            a = Ya(a);
            Sa.test(c) || N("invalid_callback");
            b = Za(b);
        ...
        Wa = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
        Va = /\/cb=/g,
        Ua = /\/\//g,
        bb = function() {
            var a = J(q.href);
    ...
    var O = decodeURI("%73cript"),
        ...
        eb = function() {
            var a = I.nonce;
            if (void 0 !== a) return a && a === String(a) && a.match(cb) ? a : I.nonce = null;
            var b = u(I, "us", []);
            ...
            for (var c = p.getElementsByTagName(O), d = 0, e = c.length; d < e; ++d) {
                ...
                if (f.src && (a = String(f.getAttribute("nonce") || "") || null)) {
                    ...
                    if (g !== k && a && a === String(a) &&
                        a.match(cb)) return I.nonce = a
                }
            }
            return null
        },
        gb = function(a) {
            if ("loading" != p.readyState) fb(a);
            else {
                var b = eb(),
                    c = "";
                null !== b && (c = ' nonce="' + b + '"');
        ...
        kb = function(a, b, c) {
            ...
            if (y.length) {
                ...
                if (y.length) {
                    ...
                    k.push.apply(k, y);
                    Oa("ml0", y, w);
                    b.sync || n.___gapisync ? gb(a) : fb(a)
                } else F[G](da)
            } else t(y) && d && d()
        };
    var ib = function(a, b) {
    ...
    var Q = function(a) {
        ...
        S = function(a, b) {
            if (b)
                for (var c in b) b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !lb(a[c]) && !lb(b[c]) ? S(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = lb(b[c]) ? [] : {}, S(a[c], b[c])) : a[c] = b[c])
        },
        mb = function(a) {
            if (a && !/^\s+$/.test(a)) {
                for (; 0 ==
        ...
        nb = function(a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = mb(f)) && b.push(f));
            a && (d = {}, S(d, a), c.push(d));
            d = Q("cd");
            a = 0;
            ...
            if (!rb) {
                ...
                if (window.self !== window.top) {
                    var a = document.location.toString(),
                        e;
                    for (e in qb) 0 < qb[e] && (b = D(a, e, "")) && (sb[e] = b)
                }
                rb = !0
            }
            e = v();
    ...
    var Bb;
    var Cb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//,
        Db = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/b\/(\d{10,21})\//,
        Eb = function(a) {
            ...
            null == b && (a = a || window.location.href, b = D(a, "authuser") ||
                null, null == b && (b = (b = a.match(Cb)) ? b[1] : null));
        ...
        Fb = function(a) {
            ...
            null == b && (b = (a = (a || window.location.href).match(Db)) ? a[1] : null);
            if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null);
            return b
    ...
    var Jb = n.crypto,
        ...
        Qb = function(a) {
            ...
            Nb = Nb * b % Ob;
            0 < Lb && ++Mb == Lb && H("mousemove", Qb, "remove", "de")
        },
        Rb = function(a) {
            var b = new Ib;
        ...
        Kb = !!Jb &&
        "function" == typeof Jb.getRandomValues;
    Kb || (Ob = 1E6 * (screen.width * screen.width + screen.height), Pb = Rb(p.cookie + "|" + p.location + "|" + (new Date).getTime() + "|" + Math.random()), Lb = T("random/maxObserveMousemove") || 0, 0 != Lb && H("mousemove", Qb, "add", "at"));
    var Sb = function() {
            var a = Nb,
                a = a + parseInt(Pb.substr(0, 20), 16);
            Pb = Rb(Pb);
            return a / (Ob + Math.pow(16, 20))
        },
        Tb = function() {
            var a = new n.Uint32Array(1);
            Jb.getRandomValues(a);
            return Number("0." + a[0])
        };
    var Ub = function() {
            var a = I.onl;
        ...
        Vb = function(a, b) {
            b = b.onload;
            return "function" === typeof b ? (Ub().a(a, b), b) : null
        },
        Wb = function(a) {
    ...
    var Yb = {
        ...
        bc = function(a, b, c, d, e) {
            ...
            for (var h in c) a = c[h], "style" === h && "object" === typeof a ? A(a, f.style) : Zb[h] || f.setAttribute(h, String(a));
    ...
    var hc = {
                ...
                switch (typeof a) {
                    ...
                    case "object":
                        ...
                        if ("number" ===
                            ...
                            d = a.length;
                            for (c = 0; c < d; c += 1) b.push(ic(a[c]) || "null");
                            return "[" + b.join(",") + "]"
                        }
                        for (c in a) !/___$/.test(c) && x(a, c) && "string" === typeof c && (d = ic(a[c])) && b.push(ic(c) + ":" + d);
                        return "{" + b.join(",") + "}"
                }
                return ""
            }
        ...
        kc = !1;
    try {
        kc = !!window.JSON && '["a"]' === window.JSON.stringify(["a"]) && "a" === window.JSON.parse('["a"]')[0]
    } catch (a) {}
    var lc = function(a) {
            try {
        ...
        mc = kc ? window.JSON.stringify : ic,
        nc = kc ? lc : jc;
    var oc = function(a) {
            var b;
        ...
        pc = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = oc(e)) && null != e.match(/^https?:\/\/[\w\-\_\.]+/i)) return e
            }
    ...
    var qc = {
        ...
        tc = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        uc = u(I, "WI", v()),
        vc = function(a, b, c) {
            var d, e;
            d = {};
            ...
            for (var g in qc) d[g] = g + "/" + (b[g] || qc[g]) + "/";
            d = ya(p, e.replace(dc,
                gc(d)));
            g = "iframes/" + a + "/params/";
            f = {};
            ...
            rc[a] || (f.origin = window.location.origin || window.location.protocol + "//" + window.location.host);
            f.exp = T(g + "exp");
            if (g = T(g + "location"))
            ...
            switch (a) {
                ...
                case "follow":
                    ...
                    g = (g = "string" == typeof g ? g : void 0) ? oc(g) : pc(e);
                    f.url = g;
                    delete f.href;
                    break;
                case "plusone":
            ...
            delete f.rd;
            for (var h in qc) f[h] && delete f[h];
        ...
        yc = function(a) {
            ...
            a = a.style;
            (c = xc(a && a.height)) && (b.height = String(c));
            (a = xc(a && a.width)) && (b.width = String(a));
            return b
        },
        xc = function(a) {
            var b = void 0;
            ...
            zb(function(b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = vc(d, b, 0);
                        g ? (f = f.parentNode,
                            e.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, zc(f, b), (d = U[f.lastChild.id]) && (d.oid = c), Ab(c, 4))) : delete U[c]
                    } else delete U[c]
                }
            })
        };
    var W, X, Y, Bc, Cc, Dc = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        Ec = {
            plusone: !0,
            autocomplete: !0,
            profile: !0,
        ...
        Fc = function(a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                h.getAttribute("data-gapiscan") ? k = null : (0 == l.indexOf("g:") ?
                    m = l.substr(2) : (h = (h = String(h.className || h.getAttribute("class"))) && Dc.exec(h)) && (m = h[1]), k = !m || !(W[m] || X[m] || Y[m]) || k && m !== k ? null : m);
                k && (Ec[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != z(yc(g)).length) && (g.setAttribute("data-gapiscan", !0), u(c, k, []).push(g))
            }
            if (b)
                for (var r in c)
                    for (b = c[r], d = 0; d < b.length; d++) b[d].setAttribute("data-onload", !0);
            for (var w in c) Bc.push(w);
            L("ps1", !0);
            if ((r = Bc.join(":")) || a) try {
                C.load(r, a)
            } catch (y) {
            ...
            if (Hc(Cc || {}))
                for (var t in c) {
                    ...
                    d = [];
                    for (t in c)
                        for (a = c[t], w = 0, b = a.length; w < b; w++) e = a[w], Jc(t, e, yc(e), d, b);
                    Kc(r, d)
                }
        },
        Lc = function(a) {
    ...
    var Ic = function(a, b) {
            ...
            switch (Pc(b, a, f)) {
                ...
                case 1:
                    ...
                    if (b.parentNode) {
                        ...
                        g.siteElement =
                            l;
                        l.id || (b = l, u(uc, a, 0), f = "___" + a + "_" + uc[a]++, b.id = f);
                        b = v();
                        b[">type"] = a;
                        A(c, b);
                        f = h;
                        ...
                        e = b = f;
                        cc.test(b) && (e = T("iframes/" + e.substring(1) + "/url"), B(!!e, "Unknown iframe url config for - " + b));
                        f = ya(p, e.replace(dc, fc));
                        b = c.ownerDocument || p;
                        l = 0;
                        do e = h.id || ["I", $b++, "_", (new Date).getTime()].join(""); while (b.getElementById(e) && 5 > ++l);
                        ...
                        t.pfname = w;
                        A(t, r);
                        (t = D(f, "rpctoken") || l.rpctoken || m.rpctoken) || (t = r.rpctoken = h.rpctoken || String(Math.round(1E8 * (Kb ? Tb() : Sb()))));
                        h.rpctoken = t;
                        t = b.location.href;
                        r = v();
                        (y = D(t, "_bsh", I.bsh)) &&
                        ...
                        if ((h || {}).allowPost && 2E3 < f.length) {
                            ...
                            m.src = "";
                            m["data-postorigin"] = f;
                            f = bc(b, c, m, e); - 1 != navigator.userAgent.indexOf("WebKit") && (k = f.contentWindow.document, k.open(), m = k.createElement("div"), r = {}, t = e + "_inner", r.name = t, r.src = "", r.style = "display:none", bc(b, m, r, t, h));
        ...
        zc = function(a, b) {
            ...
            if (d) {
                ...
                (b = !!a.ri) && delete a.ri;
                e = [];
                Jc(c, d, a, e, 0, b, void 0);
                Kc(c, e)
            } else wb("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    u(C, "platform", {}).go = Gc;
    var Hc = function(a) {
        ...
        Rc = function(a, b) {
            ...
            for (a = 0; a < b.length; a++) Lc(b[a])
        };
    M.push(["platform", function(a, b, c) {
        Cc = c;
        b && Bc.push(b);
        Rc(Mc, a);
        Rc(Nc, c._c.annotation);
        Rc(Oc, c._c.bimodal);
        pb();
        nb();
        if ("explicit" != T("parsetags")) {
            Ga(a);
            ub(tb()) && !T("disableRealtimeCallback") && yb();
            var d;
    ...
    var Tc = /^\{h\:'/,
        ...
        Wc = function(a, b) {
            a = String(a);
            if (Tc.test(a)) return !0;
            var c = !1;
            Uc.test(a) && (c = !0, a = a.substr(2));
            if (!/^\{/.test(a)) return !1;
            var d = nc(a);
            if (!d) return !1;
            a = d.f;
            if (d.s && a && -1 != fa.call(b, a)) {
                if ("_renderstart" === d.s || d.s === Vc + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = p.getElementById(a), Ab(a, 2), d && b && d.width && d.height) {
                        a: {
                            c = b.parentNode;
                            a = d || {};
                            if (xb()) {
    ...
    var Yc = function(a, b) {
        ...
        Zc = /^[-+/_=.:|%&a-zA-Z0-9@]*$/,
        $c = /^[A-Z_][A-Z0-9_]{0,63}$/;
    Yc.prototype.write = function(a, b) {
        if (!$c.test(this.O)) throw "Invalid cookie name";
        if (!Zc.test(a)) throw "Invalid cookie value";
        a = this.O + "=" + a;
    ...
    var ad = function(a) {
        ...
        bd = {};
    ad.prototype.write = function(a) {
        bd[this.X] = a;
        return !0
    };
    ad.iterate = function(a) {
        for (var b in bd) bd.hasOwnProperty(b) && a(b, bd[b])
    };
    var cd = "https:" === window.location.protocol,
        dd = cd || "http:" === window.location.protocol ? Yc : ad,
        ed = function(a) {
            var b = a.substr(1),
                c = "",
        ...
        fd = function() {
            var a, b = null;
            dd.iterate(function(c, d) {
                0 === c.indexOf("G_AUTHUSER_") && (c = ed(c.substring(11)), !a || c.g && !a.g || c.g == a.g && c.j > a.j) && (a = c, b = d)
            });
            return {
                W: a,
                B: b
    ...
    var gd = function(a) {
            ...
            if (-1 == d) return b;
            var e = ed(a.substr(d + 1));
            if (null == e) return b;
            a = a.substring(0, d);
            if ("_" !== a.charAt(0)) return b;
            d = "E" === c && e.g;
            return !d && ("U" !== c || e.g) || d && !cd ? b : {
                N: !0,
                g: d,
                ca: a.substr(1),
                domain: e.domain,
        ...
        jd = function() {
            ...
            if (null !== a) {
                var c;
                dd.iterate(function(a, d) {
                    (a = gd(a)) && a.N && a.g == b.g && a.j == b.j && (c = d)
                });
                if (c) {
                    var d = id(c),
                        e = d && d.ba[Number(a)],
    ...
    var ld = null,
        ...
        yb = function() {
            I.oa = !0;
            var a = jd();
            (a = a && a.B) && ob("googleapis.config/sessionIndex", a);
            ld || (ld = u(I, "ss", new Z(md)));
            a = ld;
            a.T && a.T()
        },
        md = function() {
            ...
            P("auth", {
                callback: function() {
                    ...
                    a.checkSessionState(e, function(b) {
                        ...
                        if (d = d != b) ob("isLoggedIn", b), yb(), Ac(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                        b =
                            tb();
                        ...
                        ob("savedUserState", c);
                        (d || f) && ub(b) && !T("disableRealtimeCallback") && a._pimf(b, !0)
                    })
                }
            });
            return !0
...
gapi.load("plusone", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.4xYG1TgbVeU.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMyX0EStHbONaNPB7FZNfj1ZKeyag",
            "u": "https://apis.google.com/js/plusone.js",
            "hee": true,
            "fp": "8263a0118625ec1277bd76b7103a6ca23b298b01",
            "dpo": false
        },
